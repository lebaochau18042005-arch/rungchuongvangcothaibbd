        ...
        <div className="max-w-4xl w-full text-center space-y-8">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-3">
              {/* Team Assigner button */}
              {teamMode && (
                <button
                  onClick={() => setShowTeamAssigner(true)}
                  className="px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white rounded-2xl font-bold text-lg shadow-lg flex items-center gap-2 transition">
                  🏆 Phân đội
                </button>
              )}
              <button
